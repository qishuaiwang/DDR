...
int dwc_ddrphy_phyinit_getUserInput(phyinit_config_t *phyctx, char *field)
{
	...
	if (strcmp(field, "CfgPStates") == 0) {
		...
		return pUserInputBasic->Lp4xMode; }
		...
		return pUserInputAdvanced->TxSlewRiseCS[4]; }
	else if (strcmp(field, "TxSlewRiseCS[5]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[5]; }
	else if (strcmp(field, "TxSlewRiseCS[6]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[6]; }
	else if (strcmp(field, "TxSlewRiseCS[7]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[7]; }
	else if (strcmp(field, "TxSlewRiseCS[8]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[8]; }
	else if (strcmp(field, "TxSlewRiseCS[9]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[9]; }
	else if (strcmp(field, "TxSlewRiseCS[10]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[10]; }
	else if (strcmp(field, "TxSlewRiseCS[11]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[11]; }
	else if (strcmp(field, "TxSlewRiseCS[12]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[12]; }
	else if (strcmp(field, "TxSlewRiseCS[13]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[13]; }
	else if (strcmp(field, "TxSlewRiseCS[14]") == 0) {
		return pUserInputAdvanced->TxSlewRiseCS[14]; }
		...
		return pUserInputAdvanced->OdtImpedanceCs[0]; }
	else if (strcmp(field, "OdtImpedanceCs[1]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[1]; }
	else if (strcmp(field, "OdtImpedanceCs[2]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[2]; }
	else if (strcmp(field, "OdtImpedanceCs[3]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[3]; }
	else if (strcmp(field, "OdtImpedanceCs[4]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[4]; }
	else if (strcmp(field, "OdtImpedanceCs[5]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[5]; }
	else if (strcmp(field, "OdtImpedanceCs[6]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[6]; }
	else if (strcmp(field, "OdtImpedanceCs[7]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[7]; }
	else if (strcmp(field, "OdtImpedanceCs[8]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[8]; }
	else if (strcmp(field, "OdtImpedanceCs[9]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[9]; }
	else if (strcmp(field, "OdtImpedanceCs[10]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[10]; }
	else if (strcmp(field, "OdtImpedanceCs[11]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[11]; }
	else if (strcmp(field, "OdtImpedanceCs[12]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[12]; }
	else if (strcmp(field, "OdtImpedanceCs[13]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[13]; }
	else if (strcmp(field, "OdtImpedanceCs[14]") == 0) {
		return pUserInputAdvanced->OdtImpedanceCs[14]; }
		...
		return pUserInputAdvanced->TxSlewFallCS[4]; }
	else if (strcmp(field, "TxSlewFallCS[5]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[5]; }
	else if (strcmp(field, "TxSlewFallCS[6]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[6]; }
	else if (strcmp(field, "TxSlewFallCS[7]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[7]; }
	else if (strcmp(field, "TxSlewFallCS[8]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[8]; }
	else if (strcmp(field, "TxSlewFallCS[9]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[9]; }
	else if (strcmp(field, "TxSlewFallCS[10]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[10]; }
	else if (strcmp(field, "TxSlewFallCS[11]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[11]; }
	else if (strcmp(field, "TxSlewFallCS[12]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[12]; }
	else if (strcmp(field, "TxSlewFallCS[13]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[13]; }
	else if (strcmp(field, "TxSlewFallCS[14]") == 0) {
		return pUserInputAdvanced->TxSlewFallCS[14]; }
		...
		return pUserInputAdvanced->TxImpedanceCs[0]; }
	else if (strcmp(field, "TxImpedanceCs[1]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[1]; }
	else if (strcmp(field, "TxImpedanceCs[2]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[2]; }
	else if (strcmp(field, "TxImpedanceCs[3]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[3]; }
	else if (strcmp(field, "TxImpedanceCs[4]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[4]; }
	else if (strcmp(field, "TxImpedanceCs[5]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[5]; }
	else if (strcmp(field, "TxImpedanceCs[6]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[6]; }
	else if (strcmp(field, "TxImpedanceCs[7]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[7]; }
	else if (strcmp(field, "TxImpedanceCs[8]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[8]; }
	else if (strcmp(field, "TxImpedanceCs[9]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[9]; }
	else if (strcmp(field, "TxImpedanceCs[10]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[10]; }
	else if (strcmp(field, "TxImpedanceCs[11]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[11]; }
	else if (strcmp(field, "TxImpedanceCs[12]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[12]; }
	else if (strcmp(field, "TxImpedanceCs[13]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[13]; }
	else if (strcmp(field, "TxImpedanceCs[14]") == 0) {
		return pUserInputAdvanced->TxImpedanceCs[14]; }
		...
		return pUserInputSim->tDQSCK; }
	else if (strcmp(field, "tDQS2DQ") == 0) {
		return pUserInputSim->tDQS2DQ; }
