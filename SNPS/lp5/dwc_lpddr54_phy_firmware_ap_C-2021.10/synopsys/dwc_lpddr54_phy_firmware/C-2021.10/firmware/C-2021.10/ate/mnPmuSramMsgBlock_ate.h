...
#define PMU_ATE_INTERNAL_REV0 0x1000u
...
typedef struct {
  ...
  uint8_t  DatLoopbackWckCoarse[4];  // Byte Offset: 0x1748 / CSR Address: 0x58ba4
                                     // Defined as DatLoopbackWckCoarse[DbyteNum]                                                             
                                     // WCK Diff slice loopback eye bitmap starting coarse value, 
                                     // indexed by Dbyte 
  uint8_t  DatLoopbackDqsCoarse[4];  // Byte Offset: 0x174c / CSR Address: 0x58ba6
                                     // Defined as DatLoopbackDqsCoarse[DbyteNum]                                                             
                                     // DQS Diff slice loopback eye bitmap starting coarse value, 
                                     // indexed by Dbyte
